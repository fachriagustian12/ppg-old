					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'kriteria'){echo 'active';} ?>"><a href="panel_admin/kriteria"><i class="icon-paragraph-justify3"></i> <span>Kriteria</span></a></li>

								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'iuran'){echo 'active';} ?>"><a href="panel_admin/iuran"><i class="icon-file-check"></i> <span>iuran</span></a></li>
