<div class="panel panel-primary">
  <div class="panel-heading">
    <h2><strong class="text-success" style="color:#eee;">Data Pedagang</strong></h2>
  </div>
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
        ...
        <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
          <input type="text" name="nik" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="30" placeholder="Nomor Induk Siswa" data-parsley-group="block1" data-parsley-errors-container='div[id="error-nis"]' required>
          ...
          <div id="pesan_komentar">*Sesuai dengan data dari KTP</div>
        </div>
    </div>
  ...
  <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" name="nokk" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="30" placeholder="NIK" data-parsley-group="block1" data-parsley-errors-container='div[id="error-nik"]' required>
        <i class="fa fa-users" style="margin-left:15px;"></i>
  ...
  <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        ...
        <div id="pesan_komentar">*Sesuai dengan akta lahir/ KTP</div>
      </div>
  </div>
      ...
      <div id="error-agama" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
              <input type="text" name="alamat_pedagang" class="form-control bg-blue class" placeholder="Alamat Lengkap Pedagang" data-parsley-group="block1" data-parsley-errors-container='div[id="error-alamat_siswa"]' required>
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
              <input type="text" name="no_hp_pedagang" class="form-control bg-blue class" maxlength="14" onkeypress="return hanyaAngka(this);" placeholder="No. Handphone Calon Siswa" data-parsley-group="block1" data-parsley-errors-container='div[id="error-no_hp_siswa"]' required>
        ...
        <div class="form-group" >
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Foto <span class="text-danger">*</span></label>
            <div class="col-sm-9 prepend-icon" style="margin-top:3px;">
              <input type="file" name="foto_pedagang" class="form-control bg-blue class" maxlength="14" onkeypress="return hanyaAngka(this);" placeholder="No. Handphone Calon Siswa" data-parsley-group="block1" data-parsley-errors-container='div[id="error-no_hp_siswa"]' required>
              <i class="fa fa-user" style="margin-left:15px;"></i>
              <div id="error-no_hp_siswa" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
            </div>
        </div>
