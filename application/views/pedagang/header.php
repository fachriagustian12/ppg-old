...
<body class="navbar-bottom <?php if($menu=='panel_pedagang' AND $sub_menu=='biodata'){echo'sidebar-xs';} ?>">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li><a href="panel_pedagang/biodata"><i class="icon-user"></i> Biodata</a></li>
						<li class="divider"></li>
						<li><a href="panel_pedagang/logout"><i class="icon-switch2"></i> Keluar</a></li>
					</ul>
				</li>
			</ul>
		</div>
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_pedagang/biodata" class="media-left"><img src="img/logo.png" class="img-circle img-sm" alt="foto"></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if($menu == 'panel_pedagang' AND $sub_menu == ''){echo 'active';} ?>"><a href="panel_pedagang"><i class="icon-home4"></i> <span>Dashboard</span></a></li>
								...
								<li><a href="panel_pedagang/logout"><i class="icon-switch2"></i> <span>Keluar</span></a></li>
								<!-- /Data Lainnya -->
